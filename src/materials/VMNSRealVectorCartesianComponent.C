...
registerMooseObject("TensorMechanicsApp", VMNSRealVectorCartesianComponent);

InputParameters
VMNSRealVectorCartesianComponent::validParams()
{
  InputParameters params = InterfaceMaterial::validParams();
  params.addClassDescription("Access a component of a RealVectorValue defined on a VMNS interface");
...
VMNSRealVectorCartesianComponent::VMNSRealVectorCartesianComponent(const InputParameters & parameters)
...
void
VMNSRealVectorCartesianComponent::computeQpProperties()
{
