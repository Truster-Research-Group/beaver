...
registerMooseObject("TensorMechanicsApp", VMNSRealVectorScalar);

InputParameters
VMNSRealVectorScalar::validParams()
{
...
VMNSRealVectorScalar::VMNSRealVectorScalar(const InputParameters & parameters)
...
void
VMNSRealVectorScalar::computeQpProperties()
{
